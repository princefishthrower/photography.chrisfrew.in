export const imageConfigItems = [
  ...
  {
    id: 45,
    path: "../images/ALPINE CANOPY.TIF",
    title: "ALPINE CANOPY",
    dateTaken: "January 22nd, 2023",
    comment: "",
    attribution: "The Author",
  },
  {
    id: 46,
    path: "../images/Frastanz in Winter.TIF",
    title: "Frastanz in Winter",
    dateTaken: "January 22nd, 2023",
    comment: "It's not often we get snow so far down to the valleys, but as soon as we do I like to get out and shoot. This is a shot of Frastanz in Vorarlberg, Austria.",
    attribution: "The Author",
  },
  {
    id: 47,
    path: "../images/A Streak in the Night II.TIF",
    title: "A Streak in the Night II",
    dateTaken: "January 22nd, 2023",
    comment: "Best shot in my opinion of this January 22nd outing. Nothing like a classic light painting shot.",
    attribution: "The Author",
  },
  {
    id: 48,
    path: "../images/Moody Winter Walgau.TIF",
    title: "Moody Winter Walgau",
    dateTaken: "January 22nd, 2023",
    comment: "A dark panorama of Walgau in winter in Vorarlberg - from Frastanz to Maria Grün. I usually don't keep the vignette on my images, but I think it works well here.",
    attribution: "The Author",
  },
  {
    id: 49,
    path: "../images/Wenns New Year 2022.TIF",
    title: "Wenns New Year 2022",
    dateTaken: "January 1st, 2023",
    comment: "The earliest shot of 2023. A firework shot from the village of Wenns in Vorarlberg, Austria.",
    attribution: "The Author",
  },
  {
    id: 50,
    path: "../images/Wenns New Year 2022 II.TIF",
    title: "Wenns New Year 2022 II",
    dateTaken: "January 1st, 2023",
    comment: "The *second* earliest shot of 2023. A firework shot from the village of Wenns in Vorarlberg, Austria.",
    attribution: "The Author",
  }
]
